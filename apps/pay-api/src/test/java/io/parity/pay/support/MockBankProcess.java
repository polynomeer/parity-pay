...
import io.parity.mockbank.MockBankApplication;
 ...
 */
final class MockBankProcess {

    private static ConfigurableApplicationContext context;
    private static int port;

    private MockBankProcess() {}
    ...
    static synchronized int start(String jdbcUrl, String username, String password) {
        ...
        properties.put("spring.config.name", "mock-bank");
        properties.put("MOCK_BANK_PORT", 0);
        properties.put("MOCK_BANK_DB_URL", jdbcUrl);
        properties.put("MOCK_BANK_DB_USERNAME", username);
        properties.put("MOCK_BANK_DB_PASSWORD", password);
        properties.put("spring.main.banner-mode", "off");
        properties.put("management.endpoints.web.exposure.include", "");

        context = new SpringApplicationBuilder(MockBankApplication.class)
