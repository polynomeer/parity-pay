...
B·C·F·J·K·L 여섯은 "대비되어 있다"고 문서에 적혀 있던 것이었습니다. → [reports/11](../reports/11-performance-failure-report.md), [reports/12 §9·§12](../reports/12-portfolio-technical-report.md)
...
6. 스택을 띄우고 데모를 돌리려면 → [DOC-21 실행·데모](21-quickstart-and-demo.md)
7. 실험을 직접 돌리고 읽으려면 → [DOC-19 실험 실행](19-experiment-runbook.md) · [DOC-20 결과 해석](20-experiment-result-interpretation.md)
